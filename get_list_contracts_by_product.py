...
if __name__ == "__main__":
    ...
    for product in list_products:
                ...
                if contract_list_products != None:
                    ...
                    for i in list_contracts:
                        if contract_num in i:
                            contract_exist = 1
                    if contract_exist == 0:
                        list_contracts.append(contract_num + ';' + contract_year_complite + ';' + product + ';' + contract_customer)
                        sum_row += 1
        ...
        file_output = data_path + 'list_contracts_' + product + '_from_' + start_date + '_to_' + end_date + '_rows_' + str(sum_row) + '.csv'
